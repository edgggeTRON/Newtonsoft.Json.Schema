            ...
            if (relativeDepth == 0)
            {
                ...
                switch (token)
                {
                    ...
                    case JsonToken.EndObject:
                        ...
                        {
                            foreach (var item in _unevaluatedScopes)
                            {
                                if (!item.Value.Evaluated)
                                {
                                    ...
                                    RaiseError(message, ErrorType.UnevaluatedProperties, Schema, item.Key, null);
                                }
                            }
                        }
